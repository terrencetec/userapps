...
MISALIGN_OFFSET = 200
MISALIGN_TRAMP = 30
MISALIGN_CHAN = 'VIS-ITMX_BF_PAYOL_OFS_Y'
...
#K1:VIS-ITMX_MN_PSDAMP
MN_LOCALDAMP = {
    'ramptime':0.5,
    'integrator':False,
    'init_FM':{'LEN':['FM1','FM8','FM9'],},
               'YAW':['FM1','FM6'],
               #'ROLL':['FM1','FM2','FM8','FM10']},
    'bst_FM':{'LEN':[],'YAW':[]},
}

#K1:VIS-ITMX_MN_MNOLDAMP
MN_MNOLDAMP = {
    'ramptime':2,
    'integrator':False,
    'init_FM':{'PIT':[],'YAW':['FM1','FM2','FM8','FM7']},
    'bst_FM':{'PIT':[],'YAW':[]},
    'DC_FM':{'PIT':[], 'YAW':[['FM1',],['FM9','FM6'],]}    
}

#K1:VIS-ITMX_MN_TMOLDAMP
MN_OLDAMP = {
    'ramptime':2,
    'integrator':False,
...
#K1:VIS-ITMX_IM_TMOLDAMP

IM_OLDAMP = {
    'ramptime':2,
    'integrator':False,
    'init_FM':{'PIT':['FM1','FM2','FM3','FM4','FM9'],
               'YAW':[]},
    'bst_FM':{'PIT':[],'YAW':[]},
    'DC_FM':{'PIT':[['FM1',],['FM8',]]}
}
...
MN_COIL_BALANCE = {
    'coils':['V3','H2','H3'],
    'freq':{'V3':5,'H2':5,'H3':6},
    'oscAMP':{'V3':3000,'H2':10000,'H3':10000},
    'sweeprange':[0.5,1.5],
    'Npoints':10,
    'duration':10,
    'SettleDuration':5,
