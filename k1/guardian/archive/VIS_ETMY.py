...
MISALIGN_OFFSET = 50
MISALIGN_TRAMP = 30
MISALIGN_CHAN = 'VIS-ETMY_BF_PAYOL_OFS_Y'
...
MN_LOCALDAMP = {
    'ramptime':0.5,
    'integrator':False,
    'init_FM':{'LEN':['FM1','FM3','FM8','FM7',],
               'TRANS':['FM1','FM7','FM6'],
               'ROLL':['FM1','FM2','FM9','FM7']},
    'bst_FM':{'LEN':['FM2','FM6'],'TRANS':[],'ROLL':[]},
}

MN_MNOLDAMP = {
    'ramptime':2,
    'integrator':False,
    'init_FM':{'PIT':[],'YAW':['FM1','FM2','FM6','FM7','FM4']},
    'bst_FM':{'PIT':[],'YAW':[]},
    'DC_FM':{'PIT':[],'YAW':[['FM1',],['FM9',],['FM3']]}
}
...
MN_OLDAMP = {
    ...
    'init_FM':{#'LEN':['FM1','FM2','FM3','FM9'],
               'PIT':['FM1','FM2','FM3','FM8'],
               'YAW':['FM1','FM2','FM3','FM4','FM5','FM6','FM7']},
               #'YAW':['FM1','FM2','FM4','FM5','FM7']},
    'bst_FM':{'LEN':[],'PIT':[],'YAW':[]},
    'DC_FM':{'LEN':[],'PIT':[['FM1',],['FM9',]],'YAW':[['FM1',],['FM9',]]}
}

IM_OLDAMP = {
    'ramptime':2,
    'integrator':False,
    'init_FM':{'PIT':['FM1','FM2','FM3','FM4','FM5','FM9'],
               #'YAW':['FM1']},
               'YAW':[]},
    'bst_FM':{'PIT':[],'YAW':[]},
    'DC_FM':{'PIT':[['FM1',],['FM8',]]}
...
MN_COIL_BALANCE = {
    ...
    'oscAMP':{'V3':3000.0,'H2':500.0,'H3':500.0},
    'sweeprange':[0.5,1.5],
    'Npoints':10,
    'duration':10,
    'SettleDuration':30,
