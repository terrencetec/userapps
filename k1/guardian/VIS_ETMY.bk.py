...
class TOWER_DAMPING(GuardState):
    index = 52
    request = False
    @watchdog_check
    def main(self):
...
class DISABLE_TM_DAMPING(GuardState):
    index = 53
    request = False
...
edges = [
    ...
    ('SAFE','OUTPUT_ON'),
    ('OUTPUT_ON','UNDAMPED'),
    ('UNDAMPED','TOWER_DAMPING'),
    ('TOWER_DAMPING','TOWER_DAMPED'),
    ('TOWER_DAMPED','DISABLE_TOWER_DAMPING'),
    ('DISABLE_TOWER_DAMPING','UNDAMPED'),
    ('TOWER_DAMPED','TM_DAMPING'),
    ('TM_DAMPING','TM_DAMPED'),
    ('TM_DAMPED','DISABLE_TM_DAMPING'),
    ('DISABLE_TM_DAMPING','TOWER_DAMPED'),
    ('TM_DAMPED','ENGAGE_DCCONTROL'),
