...
# modified on 2019.Jun.20th by YF
# modified on 2019.Jul.14th by MN
############################################
import time
import math
...
class ENGAGE_PAY_DAMPING(GuardState):
    ...
    def main(self):
        TRAMP = 10
        log('Turning on the damping filters')
        ezca.switch('VIS-' + optic + '_IM_TMOLDAMP_P','FM1','FM2','FM3','FM4','FM5','LIMIT','INPUT','OUTPUT','ON','FM6','FM7','FM8','FM9','FM10','OFF')
