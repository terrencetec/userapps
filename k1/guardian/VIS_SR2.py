...
MISALIGN_OFFSET = 300
MISALIGN_TRAMP = 10
MISALIGN_CHAN = 'VIS-SR2_IM_TEST_Y'
'''
[TODO]
...
# Threshold
###########
THRED_DISTANCE_SET2CURRENT = 50 # If the setpoint and current angle is far from each other by this threshold, guardian will not engage DC loop.
...
'''
from GRD_OLD import ENGAGE_TM_OLDAMP, ENGAGE_IM_OLDAMP, ENGAGE_OLSERVO, DISABLE_TM_OLDAMP, DISABLE_IM_OLDAMP, DISABLE_OLSERVO, ENGAGE_IM_LOCALDAMP, PAY_LOCALDAMPED, TWR_DAMPED, ALIGNED, DISABLE_IM_LOCALDAMP, edges, TRANSIT_TO_OBS, BACK_TO_ALIGNED, OBSERVATION, MISALIGNING, MISALIGNED, REALIGNING
