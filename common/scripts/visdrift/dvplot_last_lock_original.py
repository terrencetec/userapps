...
DEFAULT_FILE_PATH = ['/data/0ps_needful_things/','/opt/rtcds/userapps/trunk/sys/l1/scripts/lockloss/LOCKLOSS_App/list_of_channels/CustomList/']
...
if __name__ == '__main__':
    ...
    state_channel = [ifo.upper() + ':GRD-ISC_LOCK_STATE_N.mean,m-trend']
