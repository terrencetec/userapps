...
class Trinamic_control6110():
    ...
    def connectRS485(self, port, baudrate=9600):## NECESSARY
        try:
...
#        print 'Status',data.status
    ...
    def setTargetPosition(self, pos, motor=0):## NECESSARY
...
#        print 'Value:',data.value
    ...
    def getActualPosition(self, motor=0):## NECESSARY
        cmd = 'GAP'       # Get axis parameter
    ...
    def stop(self, motor=0):##NECESSARY
        cmd = 'MST'       # Motor stop
        type = 0          # don't care
        value = 0         # don't care
        self.sendCommand(cmd, type, motor, value)
    ...
    def getTargetSpeed(self, motor=0):##NECESSARY
        cmd = 'GAP'       # Get axis parameter
    ...
    def setTargetSpeed(self, speed, motor=0):#NECESSARY
        cmd = 'SAP'       # Get axis parameter
    ...
    def getActualSpeed(self, motor=0):#NECESSARY
        cmd = 'GAP'       # Get axis parameter
        type = 3          # Actual speed
        value = 0         # don't care
        self.sendCommand(cmd, type, motor, value)
    ...
    def setAcceleration(self, acceleration, motor=0):## NECESSARY
        cmd = 'SAP'       # Get axis parameter
        type = 5          # Max acceleration
...
if __name__ == '__main__':
    ...
    tc.connectTCP('10.68.10.250', 4001)
    #tc.sendCommand('GAP',1,1,0)
    #print tc.receiveData()
    tc.reconnect()
