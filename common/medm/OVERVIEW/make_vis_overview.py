...
if __name__=='__main__':
    systems = ['ETMX','ETMY','ITMX','ITMY','BS','SRM','SR2','SR3','PRM',
               ...
               'OSTM','TMSX','TMSY']
    models = {'ETMX':[['ETMXT',68],['ETMXP',69],['ETMXMON',79],['MODALETMX',86]],
              'ETMY':[['ETMYT',65],['ETMYP',64],['ETMYMON',80],['MODALETMY',89]],
              'ITMX':[['ITMXT',66],['ITMXP',67],['ITMXMON',77],['MODALITMX',70]],
              'ITMY':[['ITMYT',62],['ITMYP',63],['ITMYMON',78],['MODALITMY',11]],
              'BS':[['BST',93],['BSP',92]],
              'SRM':[['SRMT',58],['SRMP',59]],
              'SR2':[['SR2T',54],['SR2P',55]],
              'SR3':[['SR3T',56],['SR3P',57]],
